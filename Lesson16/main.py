...
try:
    dev = AudioUtilities.GetSpeakers() if (hasattr(AudioUtilities, "GetDefaultOutputDevice")) else AudioUtilities.GetSpeakers()
...
if (not cap.isOpened()): print("Error: Webcame not accessible.")
...
while True:
    ...
    if (res.multi_hand_landmarks and res.multi_handedness):
        for i, hand in enumerate(res.multi_hand_landmarks): 
            ...
            cv2.circle(img, tp, 10, (255, 0, 0), cv2.FILLED); cv2.cirle(img, ip, 10, (255, 0, 0), cv2.FILLED)
            ...
            if (label == "Left"):
                ...
                cv2.rectangle(img, (50, 100), (85, 400), (255,0,0), 2); cv2.rectangle(img, (50, bar), (85, 400), (255, 0, 0), cv2.FILLED)
