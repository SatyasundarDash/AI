...
cv2.rectangle(image_rgb, top_left2, bottom_right2, (255, 0, 255), 1)
...
cv2.putText(image_rgb, 'Center 1', (center1_x - 40, center1_y + 40), font,
             0.6, (0, 255, 0), 2, cv2.LINE_AA
)

cv2.putText(image_rgb, 'Center 2', (center2_x - 40, center2_y + 40), font,
             0.6, (0, 255, 0), 2, cv2.LINE_AA
)
...
cv2.putText(image_rgb, f"Height: {height}px", height_label_pos, font, 0.8,
            (255, 255, 0), 2, cv2.LINE_AA
            )

plt.figure(figsize=(12, 8))
plt.imshow(image_rgb)
plt.title("Annotated image with regions, centers and bio-directional height arrow")
